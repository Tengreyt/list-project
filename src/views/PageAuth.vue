<template>
  ...
  <div class="flex justify-content-center p-2 glow-effect">
...
const subtitleText = computed<string>(() => {
  return isLogin.value ? 'Аккаунт еще нет?' : 'Уже есть аккаунт?'
})
...
.glow-effect {
  ...
  border-radius: 8px; /* Для совпадения с border-round */
